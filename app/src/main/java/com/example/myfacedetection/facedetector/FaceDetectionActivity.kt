...
import com.example.myfacedetection.databinding.ActivityFaceDetectionBinding
import com.example.myfacedetection.camera.CameraXViewModel
...
class FaceDetectionActivity : AppCompatActivity() {
    ...
    private fun subscribeData() {
        cameraXViewModel.processCameraProvider.observe(this@FaceDetectionActivity) { provider ->
